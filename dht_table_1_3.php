...
// 쿼리 생성
$sql = "SELECT device_name, sensor_number, temperature, humidity, timestamp FROM sensor_data WHERE device_name = 'DEVICE_1' AND sensor_number = 3 ORDER BY timestamp DESC";
